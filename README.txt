WSO2 Governance Registry, v5.1.0
==================================
 ...
 * WSO2 Governance Registry Issue Tracker -
       https://wso2.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=12479
...
Known issues of WSO2 Governance Registry 5.1.0
==============================================

 * WSO2 Governance Registry Issue Tracker -
       https://wso2.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=12480
...
================================================================
    ...
    - lib
      Contains the basic set of libraries required to start-up WSO2 Governance Registry
      in standalone mode
    ...
    - release-notes.html
      Release information for WSO2 Governance Registry 5.1.0

    - resources
      Resources that are required for WSO2 Governance Registry 5.1.0 themes.
